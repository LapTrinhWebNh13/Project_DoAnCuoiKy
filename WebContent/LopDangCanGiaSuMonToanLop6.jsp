...
<title>LopDangCanGiaSuMonToanLop6</title>
	<meta charset="utf-8">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								<p><b>Mã lớp</b>: 5001</p>
								<p><b>Môn dạy</b>: Toán</p>
								<p><b>Địa chỉ</b>: Bùi Thị Xuân - P1</p>
								<p><b>Local</b>: Hồ Chí Minh Detail: Q.Tân Bình</p>
								<p><b>Lương</b>:1,200,000 đồng/tháng</p>
								<p><b>Số buổi</b>: 3 buổi /tuần</p>
								<p><b>Thời gian dạy</b>: Dạy 90 phút/buổi, T3, T5, T6 , sáng 8h - 9h30</p>
								<p><b>Yêu cầu</b>: Nữ Sinh viên </p>
								<p><b>Người học</b>: Nữ, học Trung bình</p>
								<p><b>Liên hệ</b>: 0974.502.420 - 0938.708.488</p>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6">
								<form style="background-color: #95E8E9;" action="#" name="LDCGS" id="FormLDCGS" method="post">
									<br>
									<h4 style="border-bottom: 1px solid black; text-align: center;">ĐĂNG KÝ NHANH</h4>
									<label>Tên đăng nhập</label><br>
									<input type="text" name="tendn" required="required">
									<label>Mật khẩu</label><br>
									<input type="password" name="matkhau" required="required">
									<br><br>
									<select name="hinthucnhanlop">
										<option value="35%">Chuyển khoản (lệ phí 35%)</option>
										<option value="40%">Tới trung tâm (lệ phí 40%)</option>
									</select>
									<br>
									<label>Thời gian nhận lớp</label><br>
									<input type="date" name="tgian" id="tgian" required="required">
									<br><br>
									<textarea name="yeucau" id="yeucau" rows="2" placeholder='Yêu cầu khác (nếu có)'></textarea>
									<br>
									<input type="submit" name="nhaplop" value="Nhập lớp">
								</form>
							</div>
						</div>
						<br>
